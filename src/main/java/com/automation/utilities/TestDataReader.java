...
public class TestDataReader {
  public String filename = System.getProperty("user.dir") + "\\testdata\\TestData.xls";
  public String path;
...
//      XSSFHyperlink link = createHelper.createHyperlink(XSSFHyperlink.LINK_FILE);
  ...
  /**
   * This method returns true if sheet is removed successfully else false 
...
//      style.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
  ...
  /**
   *  This method removes a column and all the contents
   * @param sheetName
   * @param colNum
   * @return
   */
...
//      style.setFillForegroundColor(HSSFColor.GREY_40_PERCENT.index);
  ...
  /**This method use to find whether sheets exists
   * @param sheetName
   * @return
   */
