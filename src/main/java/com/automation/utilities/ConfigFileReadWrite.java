...
public class ConfigFileReadWrite {
  ...
  public synchronized static <T> Boolean write(String fileName, String key, T value) {
    ...
    LOG.debug("ConfigFileReadWrite : write : Method Invoked");
    try {
      ...
      try {
        ...
        /*
         * If FileNotFoundException Not Encountered, Then Read Properties In File
         */
        ...
        try {
          ...
          LOG.debug("File : " + fileName + " Could Not Be Opened For Writing ");
      ...
      /* if File Does Not Exist, Then Create It and Open It for Write */
        ...
        try {
          bufferedWriter = new BufferedWriter(
              new PrintWriter(FileUtils.openOutputStream(new File(fileName), false)));
      ...
      /*
       * Instantiate Properties In Case, File Did Not Exist Previously, And Update New Properties
       */
      if (prop == null) {
        prop = new Properties();
        LOG.debug("Properties Instance Was Created");
      ...
      try {
        ...
        prop.put(key, value);
        LOG.debug("properties were updated for key = " + key + " ,value = " + value);
        prop.store(bufferedWriter, null);
        LOG.debug("File : " + fileName + " Was Updated For Added Property Key = " + key
            + " ,value = " + value);
        successStatus = true;
